...
global_plugins = [
    ...
    Bunch(module='Blink', tab='Blink Channels', workspace='right', start=False,
          menu="Blink Channels", category='Global.Analysis'),
    ...
    Bunch(module='ColorMapPicker', tab='Color Map Picker', workspace='right',
          start=False, category='Global.Utils'),
...
local_plugins = [
    ...
    Bunch(module='WCSAxes', workspace='dialogs', category='Analysis'),
    ...
    Bunch(module='Blink', workspace='dialogs', menu='Blink Images',
          category='Analysis'),
    Bunch(module='LineProfile', workspace='dialogs', category='Datacube'),
    ...
    Bunch(module='Mosaic', workspace='dialogs', category='Analysis'),
    ...
    Bunch(module='Catalogs', workspace='dialogs', category='Remote'),
    ]
